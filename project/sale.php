...
<body>
    ...
    <div class="container">
        ...
        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
            ...
            <div class="form-group">
                <label>Revenue:</label>
                <input type="number" step="0.01" name="Revenue" value="<?php echo $Revenue; ?>" required>
            </div>
            <div class="form-group">
            <?php if ($update === true) : ?>
            ...
            <tbody>
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<td><a href='?edit=" . $row['Sales_ID'] . "'>Edit</a> | <a href='?delete=" . $row['Sales_ID'] . "' onclick=\"return confirm('Are you sure you want to delete this record?')\">Delete</a></td>";
                        echo "</tr>";
                    }
                } else {
