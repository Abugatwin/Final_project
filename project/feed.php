...
<body>
    ...
    <?php else : ?>
        <button type="submit" name="save" class="add-btn">Save</button>
    <?php endif; ?>
</div>
        </form>
            ...
            <tbody>
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<td><a href='?edit=" . $row['FeedPurchase_ID'] . "'>Edit</a> | <a href='?delete=" . $row['FeedPurchase_ID'] . "' onclick=\"return confirm('Are you sure you want to delete this record?')\">Delete</a></td>";
                        echo "</tr>";
                    }
                } else {
